...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/eton-ai
```

A live public deployment of this template is available at [https://eton-ai.templates.workers.dev](https://eton-ai.templates.workers.dev)
